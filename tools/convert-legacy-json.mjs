...
// files under public/models/js-glb/ and their shared textures - is checked in,
...
if (typeof THREE.JSONLoader !== 'function')
{
	console.error(
		...
		'The 25 conversions are checked in under public/models/js-glb/ and are verified on\n' +
